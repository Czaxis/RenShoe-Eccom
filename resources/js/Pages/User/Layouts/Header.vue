...
<template>
        ...
        <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-8">
                    ...
                    <span class="self-center text-2xl font-bold whitespace-nowrap dark:text-white">RenShoe</span>
                    </Link>
                ...
                <div v-if="canLogin" class="flex items-center lg:space-x-2">
                    ...
                    <!--<div id="myCartDropdown1"
                        ...
                        <a href="#" title=""
                            class="mb-2 me-2 inline-flex w-full items-center justify-center rounded-lg bg-black px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                            role="button"> Proceed to Checkout </a>
                    </div>-->

                    <button v-if="auth.user" id="userDropdownButton1" data-dropdown-toggle="userDropdown1" type="button"
                    ...
                    <div v-else>
                        <Link :href="route('login')" type="button"
                            class="text-white bg-black hover:bg-black focus:outline-none focus:ring-4 focus:ring-gray-700 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-black dark:hover:bg-black dark:focus:ring-gray-700">
                        Login
                        </Link>

                        <Link :href="('register')" v-if="canRegister" type="button"
                            class="text-gray-900 hover:text-white border border-black hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-black dark:text-gray-400 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-black">
                        Register
                        </Link>

                    </div>

                    <div v-if="auth.user" class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                        id="userDropdown1">
                        <div class="py-3 px-4">
    ...
    <!--MINI BANNER-->
    <div
        class="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-100 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
        <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
            <p class="text-sm/6 text-gray-900">
                <strong class="font-semibold">Already have an account?</strong>
                <svg viewBox="0 0 2 2" class="mx-2 inline size-0.5 fill-current" aria-hidden="true"></svg>
            </p>
            <a href="#"
